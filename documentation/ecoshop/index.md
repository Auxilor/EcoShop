...
- **Build your first shop:** [How to make a Shop](how-to-make-a-shop) walks you from an empty folder to a working `/shop`.
- **Understand pricing:** [Dynamic Pricing](dynamic-pricing) explains how prices react to demand.
- **Tune the plugin:** [Plugin Config](plugin-config) covers the global menus and storage options.
